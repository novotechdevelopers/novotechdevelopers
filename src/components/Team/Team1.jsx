        ...
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="content wow fadeInUp md-mb30" data-wow-delay=".5s">
              ...
              <p>
              "Our Passionate Team combines Technical Expertise with Creative Flair to provide Outstanding Solutions in Graphic Design, Social Media Marketing, and Application Development."
              </p>
